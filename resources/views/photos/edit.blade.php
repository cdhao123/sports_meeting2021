    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('photos.update',$photo->id) }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
                <img src="{{ $photo->path }}" alt="" width="300">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="shot_time" id="shot_time" class="form-control"
                        value="{{ $photo->shot_time->toDateString() . 'T' . $photo->shot_time->format('H:i') }}">
                </div>
                <div class="form-group">
                    <label for="photo_id">赛事选择</label>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="description" id="description" class="form-control"
                        rows="3">{{ $photo->description }}</textarea>
                </div>
